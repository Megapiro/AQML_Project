\section{Conclusions}
	...
	% matte-esse: I don't understand this Recall... our last critic?
...
\section{Critical View}
	\begin{frame}[allowframebreaks]{Critical View}
		...
		% The second consideration related to the qubo formulation is its density and consequently the number of qubits that the problem needs to be embedded on the quatnum annealer. As we clearly understood from Matteo's discussion since k binary variables are needed for each of the N points we will have Nk variables in the final problem.
