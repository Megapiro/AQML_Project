\section{Conclusions}
	...
	% TODO: What we talked about on Friday: show how this impacts on |phi_j|
...
\section{Critical View}
	\begin{frame}[allowframebreaks]{Critical View}
		...
		% TODO: dire che il fairly balanced è piu verso il balanced -> perche togliendo 1/2phi_j se ci discostiamo troppo andiamo a perdere la assunzione che abbiamo fatto e non ha piu senso --> rendendo alpha looser di poco pensiamo che non crei problemi: quindi funziona per dataset che non sono balanced ma neanche troppo poco balanced
		...
		% matte-esse: we should talk about this comment on Friday
		% TODO: here explain that these are the simplest instances. This means that the quadratic term is not predominant on the linear one. As the complexity of the problem increases the more the quadratic term will be predominant. For instance: 0.0000001x^2 + 0.01x + 0.0001c --> vedere bene l'aspetto dei punti plottandoli
