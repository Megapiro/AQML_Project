...
\subsection{Balanced \textit{k}-Mean}
	...
	% This is the outline of our presentation that resembles the one of the paper
...
\subsection{Balanced \textit{k}-means clustering}
	...
	% this is the other algorithm is used for camperison w.r.t. the 
	% quantum one proposed, this one takes into consideration the
	% balanced constrained, it has complexity O(N^3)
